...
do_install() {
    ...
    install_content 0644 "lib/systemd/system/nvargus-daemon.service" "root:root"

    # Setup hwclock
    install_content 0644 "etc/systemd/system/hwclock.service" "root:root"

    install_content 0777 "usr/bin/qemu-aarch64-static" "root:root"
    
    # ln -sf ${ROOT}/dev/rtc0 ${ROOT}/dev/rtc

    # rm ${ROOT}/usr/lib/gstreamer-1.0/libgstnice.so
    # ln -s ${ROOT}/usr/lib/aarch64-linux-gnu/gstreamer-1.0/libgstnice.so ${ROOT}/usr/lib/gstreamer-1.0/
...
FILES:${PN}:append = " ${base_prefix}/usr/bin/qemu-aarch64-static"
